...
class HEmail extends HObject
{
    ...
    protected function _initMailer()
    {
        ...
        $this->_mailer->CharSet     = $this->_mailCfg['charset'] ? $this->_mailCfg['charset'] : 'UTF-8';
    ...
    protected function _send()
    {
        ...
        if(!$this->_mailer->Send()) {
            HLog::write($this->_mailer->ErrorInfo, HLog::$L_ERROR);
            return false; 
        }
    ...
    protected function _addAddress($to)
    {
        ...
        foreach($to as $address) {
            ...
            $this->_mailer->AddAddress(
                $address,
                mb_substr($address, 0, strpos($address, '@'), 'utf-8')
            );
        }
    }
