...
<?php $field = 'image_path'; require(HResponse::path('admin') . '/fields/textarea.tpl'); ?>
<?php $field = 'tag'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'publisher'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'website'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'version'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
