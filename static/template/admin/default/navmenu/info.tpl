...
<?php $field = 'position_id'; require(HResponse::path('admin') . '/fields/select.tpl'); ?>
<?php $field = 'description'; require(HResponse::path('admin') . '/fields/textarea.tpl'); ?>
<?php $field = 'target'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'extend'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
