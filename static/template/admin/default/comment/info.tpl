...
<?php $field = 'content'; require(HResponse::path('admin') . '/fields/textarea.tpl'); ?>
<?php $field = 'item_id'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
...
<?php $field = 'reply_to'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
