...
<?php $field = 'parent_id'; require(HResponse::path('admin') . '/fields/lookup.tpl'); ?>
<?php $field = 'cat_names'; require(HResponse::path('admin') . '/fields/hidden.tpl'); ?>
...
<?php $field = 'weibsite_id'; require(HResponse::path('admin') . '/fields/hidden.tpl'); ?>
