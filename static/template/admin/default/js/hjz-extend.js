 ...
 HHJsLib.extend({
    ...
    info: function(msg, callback) {
     ...
     Modal: {
         ...
         + ' <div class="modal-footer" id="dialog-footer-{id}">{footer}</div>'
         + ' </div>',
         cancelBtn: ' <button class="btn btn-grey btn-sm" data-dismiss="modal" aria-hidden="true" data-id="{id}" id="cancel-btn-{id}">取消</button>',
         okBtn: ' <button class="btn btn-primary btn-sm" data-id="{id}" id="ok-btn-{id}">确认</button>',
         ...
         confirm: function(title, content, callback) {
             return this._dialog(title, content, this.cancelBtn + this.okBtn, callback); 
         },
          ...
          * @return false
          */
         dialog: function(title, content, footer, callback) {
             return this._dialog(title, content, footer, callback); 
         },
         _dialog: function(title, content, footer, callback) {
