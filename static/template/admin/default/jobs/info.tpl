                        ...
                        <form action="<?php echo HResponse::url($modelEnName . '/' . HResponse::getAttribute('nextAction') ); ?>" method="post" enctype="multipart/form-data" id="info-form">
                            <div class="row-fluid">
                                ...
                                <!-- PAGE CONTENT BEGINS HERE -->
                                    ...
                                    <?php $field = 'company'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'url'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'job'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
...
<?php $field = 'min_money'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'max_money'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
...
<?php $field = 'total_comments'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
