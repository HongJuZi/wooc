...
<?php $field = 'code'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
...
<?php $field = 'url'; require(HResponse::path('admin') . '/fields/textarea.tpl'); ?>
<?php $field = 'goods_name'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'price'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'color'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'size'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'number'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'category'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'comment'; require(HResponse::path('admin') . '/fields/textarea.tpl'); ?>
...
<?php $field = 'need_next'; require(HResponse::path('admin') . '/fields/checkbox.tpl'); ?>
