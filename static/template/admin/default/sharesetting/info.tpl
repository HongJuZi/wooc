...
<?php $field = 'appid'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'key'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
                                    ...
                                    <div class="widget-box">
                                        ...
                                        <div class="widget-body">
                                            <div class="widget-main">
                                                <?php $field = 'identifier'; require(HResponse::path('admin') . '/fields/select.tpl'); ?>
