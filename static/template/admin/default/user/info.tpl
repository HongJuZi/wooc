...
<?php $field = 'true_name'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'password'; require(HResponse::path('admin') . '/fields/password.tpl'); ?>
<?php $field = 'sex'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'birthday'; require(HResponse::path('admin') . '/fields/date.tpl'); ?>
...
<?php $field = 'is_subscribe'; require(HResponse::path('admin') . '/fields/checkbox.tpl'); ?>
<?php $field = 'hash'; require(HResponse::path('admin') . '/fields/hidden.tpl'); ?>
<?php $field = 'u_from'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'login_time'; require(HResponse::path('admin') . '/fields/datetime.tpl'); ?>
<?php $field = 'ip'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
