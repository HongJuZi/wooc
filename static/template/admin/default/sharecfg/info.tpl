...
<?php $field = 'token'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'content'; require(HResponse::path('admin') . '/fields/code.tpl'); ?>
<?php $field = 'end_time'; require(HResponse::path('admin') . '/fields/datetime.tpl'); ?>
<?php $field = 'user_id'; require(HResponse::path('admin') . '/fields/select.tpl'); ?>
                                    ...
                                    <div class="widget-box">
                                        ...
                                        <div class="widget-body">
                                            <div class="widget-main">
                                                <?php $field = 'identifier';
                                                require(HResponse::path('admin') . '/fields/hidden.tpl'); ?>
<?php $field = 'status'; require(HResponse::path('admin') . '/fields/checkbox.tpl'); ?>
