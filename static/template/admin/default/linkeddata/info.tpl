...
<?php $field = 'res_id'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
...
<?php $field = 'is_cover'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'folder'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
<?php $field = 'model'; require(HResponse::path('admin') . '/fields/text.tpl'); ?>
                                  ...
                                  <div id="manage-box" class="tab-pane">
                                    <?php $field = 'top'; require(HResponse::path('admin') . '/fields/select.tpl'); ?>
