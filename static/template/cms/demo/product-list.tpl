              ...
              <div class="row-fluid classfy-news">
                  ...
                  <ul class="cla-title pd-0">
                    <?php foreach(HResponse::getAttribute('catList') as $item) { ?>
                      <li><a href="<?php echo HResponse::url('product/type', 'id=' . $item['id']);?>"><?php echo $item['name'];?></a></li>
                    <?php }?>
                  </ul>
              </div>
        ...
        <div class="col-md-8 article-list over_hidden ml-15">
           <div class="row-fluid">
               <p class="list-topic">
                   ...
                   <a href="<?php echo HResponse::url('product');?>"><span>产品展示</span></a>
               </p>
               <ul class="list-pic pd-0 over_hidden mt-20">
                <?php foreach(HResponse::getAttribute('list') as $item) { ?>
                   <li>
                       ...
                       <a href="<?php echo HResponse::url('product', 'id=' . $item['id']);?>"><span><?php echo $item['name'];?></span></a>
                   </li>
                <?php }?>
               </ul>
