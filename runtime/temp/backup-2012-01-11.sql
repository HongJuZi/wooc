...
)engine=MyISAM DEFAULT CHARSET=utf8 auto_increment=3 comment='单页文章信息，如：关于我们，公司介绍等。';
...
`author` varchar(50) NULL ,
`edit_time` datetime NULL 
)engine=MyISAM DEFAULT CHARSET=utf8 auto_increment=1 comment='案例详细信息';
...
`author` varchar(50) NULL ,
`edit_time` datetime NULL 
)engine=MyISAM DEFAULT CHARSET=utf8 auto_increment=1 comment='案例类型信息';
...
`author` varchar(50) NULL ,
`edit_time` datetime NULL 
)engine=MyISAM DEFAULT CHARSET=utf8 auto_increment=7 comment='公司所获得的资质荣誉';
...
`author` varchar(50) NULL ,
`edit_time` datetime NULL 
)engine=MyISAM DEFAULT CHARSET=utf8 auto_increment=3 comment='公司所获得的资质荣誉类型';
...
`author` varchar(50) NULL ,
`edit_time` datetime NULL 
)engine=MyISAM DEFAULT CHARSET=utf8 auto_increment=4 comment='工作机会信息';
...
`author` varchar(50) NULL ,
`edit_time` datetime NULL 
)engine=MyISAM DEFAULT CHARSET=utf8 auto_increment=4 comment='工作类型信息';
...
`author` varchar(50) NULL 
)engine=MyISAM DEFAULT CHARSET=utf8 auto_increment=22 comment='访客给网站的留言';
...
)engine=MyISAM DEFAULT CHARSET=utf8 auto_increment=158 comment='框架核心表，用来存储当前模块信息。';
...
`create_time` datetime NOT NULL ,
`author` varchar(50) NOT NULL 
)engine=MyISAM DEFAULT CHARSET=utf8 auto_increment=40 comment='网站导航栏';
...
`author` varchar(50) NULL ,
`edit_time` datetime NULL 
)engine=MyISAM DEFAULT CHARSET=utf8 auto_increment=6 comment='新闻详细内容';
...
`author` varchar(50) NULL ,
`edit_time` datetime NULL 
)engine=MyISAM DEFAULT CHARSET=utf8 auto_increment=2 comment='新闻分类信息';
...
`author` varchar(50) NULL ,
`edit_time` datetime NULL 
)engine=MyISAM DEFAULT CHARSET=utf8 auto_increment=5 comment='产品详细信息';
...
`author` varchar(50) NULL ,
`edit_time` datetime NULL 
)engine=MyISAM DEFAULT CHARSET=utf8 auto_increment=2 comment='产品分类信息';
...
INSERT INTO `#_jobtype` (`jobtype_id`, `jobtype_name`, `sort_num`, `seo_keywords`, `seo_desc`, `parent_id`, `model_desc`, `pass_flag`, `create_time`, `author`, `edit_time`) VALUES ('3', '业务', '9999', '业务', '业务', '-1', '业务', '2', '2012-10-30 22:10:28', 'admin', '2012-10-30 22:10:28');
--
-- #_message
--
...
INSERT INTO `#_user` (`user_id`, `user_name`, `sort_num`, `user_passwd`, `parent_id`, `pass_flag`, `top_flag`, `edit_time`, `create_time`, `author`) VALUES ('9', 'll', '9999', 'e10adc3949ba59abbe56e057f20f883e', '-1', '2', '2', '2012-10-08 20:10:56', '2012-10-08 20:10:56', 'test');
